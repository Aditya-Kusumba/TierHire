...
4. **Set up environment variables**
   ...
   ```env
   DATABASE_URL=postgresql://username:password@localhost:5432/tier_hiring_platform
...
For detailed setup instructions, navigation structure, and troubleshooting, see [SETUP.md](SETUP.md)
